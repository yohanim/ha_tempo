...
CONF_OPENDPE_SERVICE_TYPE = "opendpe_service_type"
OPENDPE_SERVICE_LIGHT = "light"
OPENDPE_SERVICE_FULL = "full"
...
DEFAULT_CONTRACT = CONTRACT_TEMPO
LEGACY_CONTRACT_MAP = {
    "Base": CONTRACT_BASE,
    "Heures Creuses": CONTRACT_HEURES_CREUSES,
    "Tempo": CONTRACT_TEMPO,
}
