...
class OptionsFlowHandler(OptionsFlow):
    ...
    async def async_step_init(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        suggested_values = {
            ...
            CONF_PRICE_UPDATE_INTERVAL: int(opts.get(CONF_PRICE_UPDATE_INTERVAL) or DEFAULT_PRICE_UPDATE_INTERVAL),
            ...
            CONF_RTE_TEMPO_COLOR_REFRESH_TIME: opts.get(CONF_RTE_TEMPO_COLOR_REFRESH_TIME) or opts.get("api_refresh_time") or DEFAULT_RTE_TEMPO_COLOR_REFRESH_TIME,
            CONF_EDF_TEMPO_COLOR_REFRESH_TIME: opts.get(CONF_EDF_TEMPO_COLOR_REFRESH_TIME, DEFAULT_EDF_TEMPO_COLOR_REFRESH_TIME),
            CONF_TEMPO_RETRY_DELAY: int(opts.get(CONF_TEMPO_RETRY_DELAY) or TEMPO_RETRY_DELAY_MINUTES),
            CONF_FORECAST_RETRY_DELAY: int(opts.get(CONF_FORECAST_RETRY_DELAY) or FORECAST_RETRY_DELAY_MINUTES),
        ...
        return self.async_show_form(
            step_id="init",
            data_schema=self.add_suggested_values_to_schema(vol.Schema(dict_schema), suggested_values),
        )
